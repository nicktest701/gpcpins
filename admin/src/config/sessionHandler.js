...
export const getToken = () => {
  const token =
    localStorage.getItem("_SSID_AdxbAb__") ||
    sessionStorage.getItem("_SSID_AdxbAb__");
...
export const saveToken = (accessToken, refreshToken) => {
  ...
  localStorage.setItem("_SSID_AdxbAb__", accessToken);
  localStorage.setItem("_SSID_AdxbAb__R", refreshToken);
...
export const deleteToken = () => {
  localStorage.removeItem("_SSID_AdxbAb__");
  localStorage.removeItem("_SSID_AdxbAb__R");
